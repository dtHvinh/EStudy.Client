...
export function CourseHeader() {
  const { course, updateCourse } = useCreateCourse();
  ...
  const handleImageUpload = async (
    ...
    try {
      ...
      updateCourse({ imageUrl: getFileUrl(imageUrl) });
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Select
                  ...
                  ) => updateCourse({ difficultyLevel: value })}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  id="duration"
                  type="number"
                  value={course.estimatedDurationHours}
                  onChange={(e) =>
                    updateCourse({
            ...
            <div className="flex items-center space-x-2">
              <Switch
                ...
                onCheckedChange={(checked) =>
                  updateCourse({ isPublished: checked })
                }
              />
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={(e) =>
                  updateCourse({ prerequisites: e.target.value })
                }
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={(e) =>
                  updateCourse({ learningObjectives: e.target.value })
                }
